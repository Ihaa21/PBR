...
cl %CommonCompilerFlags% %CodeDir%\pbr_demo.cpp -Fmpbr_demo.map -LD /link %CommonLinkerFlags% -incremental:no -opt:ref -PDB:pbr_demo_%random%.pdb -EXPORT:Init -EXPORT:CodeReload -EXPORT:MainLoop
del lock.tmp
